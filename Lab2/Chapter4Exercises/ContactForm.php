...
<body>
  <?php
    function validateInput($data, $fieldName) 
    {
        ...
        {
            //only clean up input if it isnt empty
            $retval = trim($data);
    ...
    function validateEmail($data, $fieldName) 
    {
        ...
        else 
        {
            ...
            if(preg_macth($pattern, $retval) == 0) 
            {
    ...
    if(isset($_POST['Submit'])) 
    {
        ...
        $Message = validateInput($_POST['Mesasge'], "Message");
    ...
    else 
    {
        ...
        //Substitute your own e-mail for recipient@example.com
